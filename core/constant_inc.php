...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	define( 'ERROR_SESSION_VAR_NOT_FOUND',				250 );
	define( 'ERROR_SESSION_ARRAY_EXPECTED',				251 );
	define( 'ERROR_SESSION_ARRAY_UNEXPECTED',			252 );
	define( 'ERROR_SESSION_NOT_NUMBER',			253 );
