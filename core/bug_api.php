...
class BugData {
	...
	function create() {
		...
		event_signal( 'EVENT_BUG_CREATE_PRE', array( array( 'new' => $this ) ) );
		...
		event_signal( 'EVENT_BUG_CREATE_POST', array( array( 'new' => $this ) ) );
	...
	function update( $p_update_extended = false, $p_bypass_mail = false ) {
		...
		event_signal( 'EVENT_BUG_UPDATE_PRE', array( array( 'new' => $this, 'old' => $t_old_data ) ) );
		$c_bug_id = $this->id;
		...
		event_signal( 'EVENT_BUG_UPDATE_POST', array( array( 'new' => $this, 'old' => $t_old_data ) ) );
