<?php
	...
	# --------------------------------------------------------
	# $Id: my_view_inc_reported.php,v 1.2 2004-06-28 13:04:32 prichards Exp $
	# --------------------------------------------------------
?>
<?php
	$c_filter_reported = array(
		'_version'		=> 'v5',			'show_category'		=> Array ( '0' => 'any' ),
		'show_severity'		=> Array ( '0' => 'any' ),	'show_status'		=> Array ( '0' => 'any' ),
		'per_page'		=> '50',			'highlight_changed'	=> '6',
		'hide_closed'		=> 'on',			'reporter_id'		=> Array ( '0' => $t_current_user_id ),
	...
	$rows = filter_get_bug_rows ( $f_page_number, $t_per_page, $t_page_count, $t_bug_count, $c_filter_reported );
