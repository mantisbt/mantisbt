...
class MantisDatabase_PDO_Pgsql extends MantisDatabase_PDO {
	...
	protected function get_dsn() {
		if( !is_blank( $this->dbname ) ) {
			return  'pgsql:host=' . $this->dbhost . ';dbname=' . $this->dbname . ';user=' . $this->dbuser . ';password=' . $this->dbpass;
		} else {
			return  'pgsql:host=' . $this->dbhost . ';user=' . $this->dbuser . ';password=' . $this->dbpass;
		}
	}
