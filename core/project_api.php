 ...
 * @param integer $p_exclude_id Optional project id to exclude from the check, to allow uniqueness check when updating.
 * @return boolean
 */
...
{
    event_signal('EVENT_MANAGE_PROJECT_DELETE', array (
        $p_project_id
    ));
