<html>
    ...
    <body style="font-family: arial;">
        <div style="-webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px; background-color: #F0F0F0; padding: 15px;">
            ...
            <a href="view_user_page.php?id={{reporter.id}}" style="text-decoration:none; color: DarkCyan;">{{reporter.name}}</a> has reported issue <a href="view.php?id={{id}}" style="text-decoration:none; color: DarkCyan;">{{id}}</a><br />
