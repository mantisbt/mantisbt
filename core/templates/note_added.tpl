<html>
    ...
    <body style="font-family: arial;">
        <div style="-webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px; background-color: #F0F0F0; padding: 15px;">
            ...
            <a href="view_user_page.php?id={{author.id}}" style="text-decoration:none; color: DarkCyan;">{{author.name}}</a> has commented on <a href="view.php?id={{issue_id}}" style="text-decoration:none; color: DarkCyan;">{{issue_id}}</a><br />
