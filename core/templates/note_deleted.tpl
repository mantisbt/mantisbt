<html>
    ...
    <body style="font-family: arial;">
        <div style="-webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px; background-color: #F0F0F0; padding: 15px;">
            ...
            <a href="view_user_page.php?id={{user.id}}" style="text-decoration:none; color: DarkCyan;">{{user.name}}</a> has deleted comment from <a href="view.php?id={{issue_id}}" style="text-decoration:none; color: DarkCyan;">{{issue_id}}</a><br />
            ...
            <fieldset style="-webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px; background-color: white; padding: 15px;">
                ...
                <table cellpadding="5">
                    <tr valign="top">
                        ...
                        <td>
                            <span style='text-decoration:line-through; background-color: Salmon;'>{{text}}</span>
                        </td>
                    </tr>
                </table>
