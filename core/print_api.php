...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	function print_rss( $p_feed_url, $p_title = '' ) {
		...
		echo '<a href="', $p_feed_url, '" title="', $p_title, '"><img src="', $t_path, '/images/', 'rss.png" border="0" alt="', $p_title, '" width="26" height="13" /></a>';
	}
	...
	function print_bug_attachments_list( $p_bug_id ) {
		# @@@ Change this to a function that wraps file_get_visible_attachments()
