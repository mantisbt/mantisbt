...
function print_bugnote_form_content( $p_bug_id ) {
	...
	<div class="table-responsive">
		<table class="table table-bordered table-condensed">
			...
			<?php if( access_has_bug_level( config_get( 'set_view_status_threshold' ), $p_bug_id ) ) { ?>
				<tr>
					<th class="category">
			...
			<?php if( config_get( 'time_tracking_enabled' ) && access_has_bug_level( config_get( 'time_tracking_edit_threshold' ), $p_bug_id ) ) { ?>
				<tr>
					<th class="category">
			...
			<?php if( file_allow_bug_upload( $p_bug_id ) ) {
			...
			<?php event_signal( 'EVENT_BUGNOTE_ADD_FORM', array( $p_bug_id ) ); ?>
