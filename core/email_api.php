...
/* Kimberly Keown suggested revision to add a custom email signature. 
	Suggested code revisions in three places on this page (search Kimberly Keown), undoubtedly there are other messages to include 
...
/* Kimberly Keown suggested revision to add a custom email subject line preface to replace window title:
Add $s_custom_preface_subject to custom_strings_inc.php (or default language file + new string option in config.php) 
and implement into manage_user_update.php and core/email_api.php.(Reference Line 522.) 
	Ex. custom_strings_inc.php: 
	$s_custom_preface_subject = 'My Company Title'; 
	
	Revised Code:*/
	$t_subject = '[' . lang_get( 'custom_preface_subject' ) . '] ' . lang_get( 'lost_password_subject' ) ;
