<?php
	...
	#
	# $Id: bug_update_page.php,v 1.20 2002-08-16 06:38:34 jfitzell Exp $
	# --------------------------------------------------------
?>
<?php
...
<?php
	...
	if ( ADVANCED_ONLY == $g_show_update ) {
		print_header_redirect ( 'bug_update_advanced_page.php?f_id='.$c_id );
	}
...
<?php
	switch ( $g_show_view ) {
		case 0: print_bracket_link( 'view_bug_page.php?f_id='.$c_id, $s_back_to_bug_link );
				break;
	...
	if ( BOTH == $g_show_update ) {
		print_bracket_link( 'bug_update_advanced_page.php?f_id='.$c_id, $s_update_advanced_link );
	}
?>
	</td>
</tr>
