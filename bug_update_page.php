...
$t_fields_status = config_get( 'bug_update_page_fields_by_status' );
$t_fields_status = isset($t_fields_status[ $t_bug->status ] ) ? columns_filter_disabled( $t_fields_status[ $t_bug->status ] ) : null;
...
$t_show_id = in_array( 'id', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'id' , $t_fields_status ));
$t_show_project = in_array( 'project', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'project' , $t_fields_status ));
$t_show_category = in_array( 'category_id', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'category_id' , $t_fields_status ));
$t_show_view_state = in_array( 'view_state', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'view_state' , $t_fields_status ));
$t_view_state = $t_show_view_state ? string_display_line( get_enum_element( 'view_state', $t_bug->view_state ) ) : '';
$t_show_date_submitted = in_array( 'date_submitted', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'date_submitted' , $t_fields_status ));
$t_show_last_updated = in_array( 'last_updated', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'last_updated' , $t_fields_status ));
$t_show_reporter = in_array( 'reporter', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'reporter' , $t_fields_status ));
$t_show_handler = in_array( 'handler', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'handler' , $t_fields_status )) && access_has_bug_level( config_get( 'view_handler_threshold' ), $t_bug_id );
$t_show_priority = in_array( 'priority', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'priority' , $t_fields_status ));
$t_show_severity = in_array( 'severity', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'severity' , $t_fields_status ));
$t_show_reproducibility = in_array( 'reproducibility', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'reproducibility' , $t_fields_status ));
$t_show_status = in_array( 'status', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'status' , $t_fields_status ));
$t_show_resolution = in_array( 'resolution', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'resolution' , $t_fields_status ));
$t_show_projection = in_array( 'projection', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'projection' , $t_fields_status )) && config_get( 'enable_projection' ) == ON;
$t_show_eta = in_array( 'eta', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'eta' , $t_fields_status )) && config_get( 'enable_eta' ) == ON;
$t_show_profiles = config_get( 'enable_profiles' ) == ON;
$t_show_platform = $t_show_profiles && in_array( 'platform', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'platform' , $t_fields_status ));
$t_show_os = $t_show_profiles && in_array( 'os', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'os' , $t_fields_status ));
$t_show_os_version = $t_show_profiles && in_array( 'os_version', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'os_version' , $t_fields_status ));
$t_show_versions = version_should_show_product_version( $t_bug->project_id );
$t_show_product_version = $t_show_versions && in_array( 'product_version', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'product_version' , $t_fields_status ));
$t_show_product_build = $t_show_versions && in_array( 'product_build', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'product_build' , $t_fields_status )) && ( config_get( 'enable_product_build' ) == ON );
$t_product_build_attribute = $t_show_product_build ? string_attribute( $t_bug->build ) : '';
$t_show_target_version = $t_show_versions && in_array( 'target_version', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'target_version' , $t_fields_status )) && access_has_bug_level( config_get( 'roadmap_update_threshold' ), $t_bug_id );
$t_show_fixed_in_version = $t_show_versions && in_array( 'fixed_in_version', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'fixed_in_version' , $t_fields_status ));
$t_show_due_date = in_array( 'due_date', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'due_date' , $t_fields_status )) && access_has_bug_level( config_get( 'due_date_view_threshold' ), $t_bug_id );
$t_show_summary = in_array( 'summary', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'summary' , $t_fields_status ));
$t_summary_attribute = $t_show_summary ? string_attribute( $t_bug->summary ) : '';
$t_show_description = in_array( 'description', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'description' , $t_fields_status ));
$t_description_textarea = $t_show_description ? string_textarea( $t_bug->description ) : '';
$t_show_additional_information = in_array( 'additional_info', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'additional_info' , $t_fields_status ));
$t_additional_information_textarea = $t_show_additional_information ? string_textarea( $t_bug->additional_information ) : '';
$t_show_steps_to_reproduce = in_array( 'steps_to_reproduce', $t_fields ) && ( !is_array($t_fields_status) || in_array( 'steps_to_reproduce' , $t_fields_status ));
