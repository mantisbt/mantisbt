...
<?
	...
	if ( $f_offset_prev >= 0 ) {
 		PRINT "[ <a href=\"$g_view_user_reported_bug_page?f_offset=$f_offset_prev&f_show_category=$f_show_category&f_show_severity=$f_show_severity&f_show_status=$f_show_status&f_limit_view=$f_limit_view&f_show_changed=$f_show_changed&f_hide_resolved=$f_hide_resolved\">View Prev $f_limit_view</a> ] ";
	}
	if ( $row_count == $f_limit_view ) {
 		PRINT "[ <a href=\"$g_view_user_reported_bug_page?f_offset=$f_offset_next&f_show_category=$f_show_category&f_show_severity=$f_show_severity&f_show_status=$f_show_status&f_limit_view=$f_limit_view&f_show_changed=$f_show_changed&f_hide_resolved=$f_hide_resolved\">View Next $f_limit_view</a> ]";
	}
?>
</div>
