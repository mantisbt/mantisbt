...
<tr <?php echo helper_alternate_class( )?>>
	...
	<td style="vertical-align: top">
		...
		<label><input type="radio" name="font" value="dejavuserif"<?php echo print_font_checked( 'dejavuserif' )?>/>DejaVu Serif</label><br />
		<br />Monospace:<br />
		<label><input type="radio" name="font" value="courier"<?php echo print_font_checked( 'courier' )?>/>Courier</label><br />
		<label><input type="radio" name="font" value="veramono"<?php echo print_font_checked( 'veramono' )?>/>Vera Mono</label><br />
