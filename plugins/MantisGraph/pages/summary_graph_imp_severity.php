...
<tr>
	<td class="center">
		<img src="<?php echo plugin_page( 'summary_graph_byseverity.php')?>&amp;width=<?php echo $t_graph_width?>" border="0" alt="" />
	</td>
</tr>
<tr>
	<td class="center">
		<img src="<?php echo plugin_page( 'summary_graph_byseverity_pct.php')?>&amp;width=<?php echo $t_graph_width?>" border="0" alt="" />
	</td>
</tr>
<tr>
	<td class="center">
		<img src="<?php echo plugin_page( 'summary_graph_byseverity_mix.php')?>&amp;width=<?php echo $t_graph_width?>" border="0" alt="" />
	</td>
</tr>
</table>
