...
class MantisGraphPlugin extends MantisPlugin  {
	...
	function summary_submenu() {
		...
		return array( '<a href="' . helper_mantis_url( 'summary_page.php' ) . '"><img src="' . $t_icon_path . 'synthese.png" alt="" />' . plugin_lang_get( 'synthesis_link' ) . '</a>',
			'<a href="' . plugin_page( 'summary_graph_imp_status.php' ) . '"><img src="' . $t_icon_path . 'synthgraph.png" alt="" />' . plugin_lang_get( 'status_link' ) . '</a>',
			'<a href="' . plugin_page( 'summary_graph_imp_priority.php' ) . '"><img src="' . $t_icon_path . 'synthgraph.png" alt="" />' . plugin_lang_get( 'priority_link' ) . '</a>',
			'<a href="' . plugin_page( 'summary_graph_imp_severity.php' ) . '"><img src="' . $t_icon_path . 'synthgraph.png" alt="" />' . plugin_lang_get( 'severity_link' ) . '</a>',
			'<a href="' . plugin_page( 'summary_graph_imp_category.php' ) . '"><img src="' . $t_icon_path . 'synthgraph.png" alt="" />' . plugin_lang_get( 'category_link' ) . '</a>',
			'<a href="' . plugin_page( 'summary_graph_imp_resolution.php' ) . '"><img src="' . $t_icon_path . 'synthgraph.png" alt="" />' . plugin_lang_get( 'resolution_link' ) . '</a>',
		);
	}
}
