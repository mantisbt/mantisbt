...
class PluginTest extends MantisCoreBase {
	...
	public function providerDependency() {
		return [
			[ '1.3.0', self::REQ_13, true ],
			[ '1.3.0', self::REQ_130, true ],
			[ '1.3.0', self::REQ_131, false ],
			[ '1.3.0', self::REQ_13_20, true ],
			[ '1.3.0', self::REQ_13_30, true ],
			[ '1.3.0', self::REQ_20, false ],

			[ '2.0.0', self::REQ_13, false ],
			[ '2.0.0', self::REQ_13_20, false ],
			[ '2.0.0', self::REQ_13_21, true ],
			[ '2.0.0', self::REQ_13_30, true ],
			[ '2.0.0', self::REQ_20, true ],
			[ '2.0.0', self::REQ_210_DEV, false ],
			[ '2.0.0-beta.1', self::REQ_20, true ],

			[ '2.1.0', self::REQ_13, false ],
			[ '2.1.0', self::REQ_13_20, false ],
			[ '2.1.0', self::REQ_13_21, false ],
			[ '2.1.0', self::REQ_13_30, true ],
			[ '2.1.0', self::REQ_20, true ],
			[ '2.1.0', self::REQ_21, true ],
			[ '2.1.0', self::REQ_210_DEV, true ],
			[ '2.1.0', self::REQ_210_B1, true ],
			[ '2.1.0', self::REQ_211, false ],
			[ '2.1.0-dev', self::REQ_21, true ],
			[ '2.1.0-dev', self::REQ_210, false ],
			[ '2.1.0-dev', self::REQ_210_DEV, true ],
			[ '2.1.0-dev', self::REQ_210_A1, false ],
			[ '2.1.0-alpha.1', self::REQ_21, true ],
			[ '2.1.0-alpha.1', self::REQ_210_DEV, true ],

			[ '2.1.1', self::REQ_20, true ],
			[ '2.1.1', self::REQ_21, true ],
			[ '2.1.1', self::REQ_211, true ],

			[ '3.0.0', self::REQ_13_20, false ],
			[ '3.0.0', self::REQ_13_30, false ],
			[ '3.0.0', self::REQ_20, false ],
		];
	}
