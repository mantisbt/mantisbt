...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_config_table' ),
		"
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_bug_history_table' ),
		"
  id 			 I  UNSIGNED NOTNULL PRIMARY AUTOINCREMENT,
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_bug_monitor_table' ),
		"
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_bug_relationship_table' ),
		"
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_bug_text_table' ),
		"
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_bugnote_text_table' ),
		"
  id 			 I  UNSIGNED NOTNULL PRIMARY AUTOINCREMENT,
  note 			XL NOTNULL
",
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_custom_field_project_table' ),
		"
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_custom_field_string_table' ),
		"
  field_id 		 I  NOTNULL PRIMARY DEFAULT '0',
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_custom_field_table' ),
		"
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_news_table' ),
		"
  id 			 I  UNSIGNED PRIMARY NOTNULL AUTOINCREMENT,
  project_id 		 I  UNSIGNED NOTNULL DEFAULT '0',
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_project_category_table' ),
		"
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_project_file_table' ),
		"
  id 			 I  UNSIGNED NOTNULL PRIMARY AUTOINCREMENT,
  project_id 		 I  UNSIGNED NOTNULL DEFAULT '0',
  title 		C(250) NOTNULL DEFAULT \" '' \",
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_project_hierarchy_table' ),
		"
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_project_table' ),
		"
  id 			 I  UNSIGNED PRIMARY NOTNULL AUTOINCREMENT,
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_project_user_list_table' ),
		"
  project_id 		 I  UNSIGNED PRIMARY NOTNULL DEFAULT '0',
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_project_version_table' ),
		"
  id 			 I  NOTNULL PRIMARY AUTOINCREMENT,
  project_id 		 I  UNSIGNED NOTNULL DEFAULT '0',
  version 		C(64) NOTNULL DEFAULT \" '' \",
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_tokens_table' ),
		"
			  id I NOTNULL PRIMARY AUTOINCREMENT,
			  owner I NOTNULL,
			  type I NOTNULL,
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_user_pref_table' ),
		"
  id 			 I  UNSIGNED NOTNULL PRIMARY AUTOINCREMENT,
  user_id 		 I  UNSIGNED NOTNULL DEFAULT '0',
  project_id 		 I  UNSIGNED NOTNULL DEFAULT '0',
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_user_print_pref_table' ),
		"
  user_id 		 I  UNSIGNED NOTNULL PRIMARY DEFAULT '0',
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_user_profile_table' ),
		"
  id 			 I  UNSIGNED NOTNULL PRIMARY AUTOINCREMENT,
  user_id 		 I  UNSIGNED NOTNULL DEFAULT '0',
  platform 		C(32) NOTNULL DEFAULT \" '' \",
...
$upgrade[] = Array(
	...
	Array(
        ...
        ('administrator', '', 'root@localhost', '63a9f0ea7bb98050796b649e85481845', '" . db_now( ) . "', '" . db_now( ) . "', '1', '0', 90, 3, 0, 0, '" . md5( mt_rand( 0,
		mt_getrandmax( ) ) + mt_rand( 0,
		mt_getrandmax( ) ) ) . md5( time( ) ) . "')",
	),
);
$upgrade[] = Array(
	'AlterColumnSQL',
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_email_table' ),
		"
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_bug_tag_table' ),
		"
	bug_id			I	UNSIGNED NOTNULL PRIMARY DEFAULT '0',
...
$upgrade[] = Array(
	'CreateTableSQL',
	Array(
		db_get_table( 'mantis_plugin_table' ),
		"
