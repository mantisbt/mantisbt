...
# NOTE: this is just the base name, the actual PHP include file name and related
# "ALLOW" constant will be derived from it (see foreach loop below).
$t_checks_list = [
	'php',
	'database',
	'config',
	'paths',
	'webservice',
	# Disable integrity checks since the required blobs are no longer available
...
foreach( $t_checks_list as $t_check ) {
	$t_base_name = "check_{$t_check}_inc";

	define( strtoupper( $t_base_name ) . '_ALLOW', true );
	include $t_base_name . '.php';
