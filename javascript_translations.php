...
print_translation( 'dropzone_default_message' );
print_translation( 'dropzone_fallback_message' );
print_translation( 'dropzone_fallback_text' );
print_translation( 'dropzone_file_too_big' );
print_translation( 'dropzone_invalid_file_type' );
print_translation( 'dropzone_response_error' );
print_translation( 'dropzone_cancel_upload' );
print_translation( 'dropzone_cancel_upload_confirmation' );
print_translation( 'dropzone_remove_file' );
print_translation( 'dropzone_remove_file_confirmation' );
print_translation( 'dropzone_max_files_exceeded' );
print_translation( 'dropzone_not_supported' );
