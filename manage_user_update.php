...
if ( $f_protected && $t_old_protected ) {
	$t_query = "UPDATE {user} SET username=%s, email=%s, protected=%d, realname=%s WHERE id=%d";
	...
	$t_query = "UPDATE {user} SET username=%s, email=%s, access_level=%d, enabled=%d, protected=%d, realname=%s WHERE id=%d";
