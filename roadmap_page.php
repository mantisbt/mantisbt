...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
  ...
  function print_version_header( $p_version_row ) {
    ...
    if ( config_get( 'show_roadmap_dates' ) && $p_version_row['date_order']) {
  ...
  function print_version(&$t_project_header_printed, $t_project_name, $t_project_id, $t_version_row, $only_open) {
    ...
    if ($only_open) {
      $query .= " AND sbt.status < ".config_get('bug_resolved_status_threshold');
    }
    $query .= " ORDER BY sbt.status ASC, sbt.last_updated DESC";
  ...
  foreach( $t_project_ids as $t_project_id ) {
    ...
    foreach( $t_version_rows as $t_version_row ) {
      ...
      print_version($t_project_header_printed, $t_project_name, $t_project_id, $t_version_row, false);
    ...
    if (config_get( 'show_roadmap_unassigned')) {
      ...
      print_version($t_project_header_printed, $t_project_name, $t_project_id, $t_version_row, true);
    }
