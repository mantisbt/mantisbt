...
-->
	[ <a href="<? echo $g_path.$g_documentation_page ?>"><? echo $s_documentation_link ?></a> ]
</div>
...
<tr>
	...
	<tr align=center bgcolor=<?echo $g_category_title_color2 ?>>
		<td>
			<b><a href="<? echo $g_manage_page ?>?f_sort=username&f_dir=<? echo $f_dir?>"><? echo $s_username ?></a></b>
		</td>
		<td>
			<b><a href="<? echo $g_manage_page ?>?f_sort=email&f_dir=<? echo $f_dir?>"><? echo $s_email ?></a></b>
		</td>
		<td>
			<b><a href="<? echo $g_manage_page ?>?f_sort=access_level&f_dir=<? echo $f_dir?>"><? echo $s_access_level ?></a></b>
		</td>
		<td>
			<b><a href="<? echo $g_manage_page ?>?f_sort=enabled&f_dir=<? echo $f_dir?>"><? echo $s_enabled ?></a></b>
		</td>
		<td>
			<b><a href="<? echo $g_manage_page ?>?f_sort=protected&f_dir=<? echo $f_dir?>"><? echo $s_p ?></a></b>
		</td>
		<td>
			<b><a href="<? echo $g_manage_page ?>?f_sort=date_created&f_dir=<? echo $f_dir?>"><? echo $s_date_created ?></a></b>
		</td>
		<td>
			<b><a href="<? echo $g_manage_page ?>?f_sort=last_visit&f_dir=<? echo $f_dir?>"><? echo $s_last_visit ?></a></b>
		</td>
		<td>
		</td>
	</tr>
<?
	...
	for ($i=0;$i<$user_count;$i++) {
		...
		$u_date_created  = date( $g_normal_date_format, sql_to_unix_time( $u_date_created ) );
...
?>
	<tr bgcolor=<? echo $bgcolor ?>>
		...
		<td align=center>
			<a href="<? echo $g_path.$g_manage_user_page ?>?f_id=<? echo $u_id ?>"><? echo $s_edit_user_link ?></a>
		</td>
	</tr>
<?
	}  ### end for
