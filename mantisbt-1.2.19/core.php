...
require_once( 'core/error_api.php' );
...
# PHP Sessions
require_once( 'core/session_api.php' );

# Initialize Event System
require_once( 'core/event_api.php' );
require_once( 'core/events_inc.php' );
...
require_once( 'core/project_hierarchy_api.php' );
require_once( 'core/user_api.php' );
require_once( 'core/access_api.php' );

# Wiki Integration
if( config_get_global( 'wiki_enable' ) == ON ) {
	require_once( 'core/wiki_api.php' );
	wiki_init();
}
...
require_once( 'core/collapse_api.php' );
