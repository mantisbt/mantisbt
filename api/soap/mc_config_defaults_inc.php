...
$MantisConfig->mc_readonly_access_level_threshold = REPORTER;

# Minimum global access level required to access webservice for read/write operations.
$MantisConfig->mc_readwrite_access_level_threshold = REPORTER;

# Minimum global access level required to access the administrator webservices
$MantisConfig->mc_admin_access_level_threshold = MANAGER;
...
$MantisConfig->mc_specify_reporter_on_add_access_level_threshold = DEVELOPER;
...
$MantisConfig->mc_priority_enum_default_when_not_found = 0;
$MantisConfig->mc_severity_enum_default_when_not_found = 0;
$MantisConfig->mc_status_enum_default_when_not_found = 0;
$MantisConfig->mc_resolution_enum_default_when_not_found = 0;
$MantisConfig->mc_projection_enum_default_when_not_found = 0;
$MantisConfig->mc_eta_enum_default_when_not_found = 0;
