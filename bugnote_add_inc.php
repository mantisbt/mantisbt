...
<span class="<?php echo helper_alternate_class() ?>"></span>
...
<?php event_signal( 'EVENT_BUGNOTE_ADD_FORM', array( $f_bug_id ) ); ?>
		...
		<input type="submit" class="btn btn-primary" value="<?php echo lang_get( 'add_bugnote_button' ) ?>"  onclick="this.disabled=1;document.bugnoteadd.submit();" />
