	...
	<form id="manage-user-create-form" method="post" action="manage_user_create.php">
		<fieldset>
			...
			<div class="field-container">
				...
				<span class="input"><input type="password" autocomplete="off" id="user-password" name="password" size="32" maxlength="<?php echo auth_get_password_max_size(); ?>" /></span>
				<span class="label-style"></span>
			</div>
			<div class="field-container">
				<label for="user-verify-password"><span><?php echo lang_get( 'verify_password' ) ?></span></label>
				<span class="input"><input type="password" autocomplete="off" id="user-verify-password" name="password_verify" size="32" maxlength="<?php echo auth_get_password_max_size(); ?>" /></span>
				<span class="label-style"></span>
			</div><?php
			} ?>
			<div class="field-container">
