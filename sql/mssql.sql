...
CREATE TABLE mantis_bug_table (
  ...
  priority tinyint NOT NULL default '30',
  severity tinyint NOT NULL default '50',
  reproducibility tinyint NOT NULL default '10',
  status tinyint NOT NULL default '10',
  resolution tinyint NOT NULL default '10',
  projection tinyint NOT NULL default '10',
  ...
  eta tinyint NOT NULL default '10',
...
CREATE TABLE mantis_project_table (
  ...
  view_state tinyint NOT NULL default '10',
  access_min tinyint NOT NULL default '10',
