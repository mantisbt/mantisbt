...
project_update ( $f_project_id, $f_language, $f_name, $f_description, $f_status, $f_view_state, $f_file_path, $f_enabled, $f_inherit_global );
event_signal ( 'EVENT_MANAGE_PROJECT_UPDATE', array (
		$f_project_id
) );
