                        ...
                        <div class="widget-main no-padding">
                            ...
                            <fieldset>
                                ...
                                <div class="field-container">
                                    ...
                                    <span class="input"><input type="text" id="custom-field-possible-values" name="possible_values" class="form-control" value="<?php echo string_attribute( $t_definition['possible_values'] ) ?>" /></span>
                                    <span class="label-style"></span>
                                </div>
                                <div class="field-container">
