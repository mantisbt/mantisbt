...
?>
			<input type="hidden" id="custom-field-id" name="field_id" value="<?php
...
echo lang_get('language')?>
		...
		<td>
			<select id="custom-field-language" name="language" class="input-sm">
    			<?php
...
echo lang_get('custom_field_name')?>
		...
		<td>
			<input type="text" id="custom-field-name" name="name" class="input-sm" size="32" maxlength="64" value="<?php

echo string_attribute($t_definition['name'])?>" />
		</td>
	</tr>
	<tr>
		<td class="category">
...
print_enum_string_option_list('custom_field_type', (int) $t_definition['type'])?>
			</select>
		</td>
	</tr>
	<tr>
...
echo lang_get('custom_field_possible_values')?>
		...
		<td>
			<input type="text" id="custom-field-possible-values" name="possible_values" class="input-sm" size="80%" value="<?php

echo string_attribute($t_definition['possible_values'])?>" />
            <small><?php

echo sprintf(lang_get('separate_list_items_by'), '|')?></small>
		</td>
	</tr>
	<tr>
		<td class="category">
...
echo lang_get('custom_field_default_value')?>
		...
		<td>
			<div class="input">
				<input type="text" id="custom-field-default-value" name="default_value" class="input-sm" size="32" maxlength="255" value="<?php

echo string_attribute($t_definition['default_value'])?>" />
			</div>
			<div class="textarea">
				<textarea disabled="disabled" id="custom-field-default-value-textarea" name="default_value" class="form-control" cols="80" rows="10"><?php

echo string_attribute($t_definition['default_value'])?></textarea>
			</div>
		</td>
	</tr>
	<tr>
...
echo lang_get('custom_field_valid_regexp')?>
		...
		<td>
			<input type="text" id="custom-field-valid-regexp" name="valid_regexp" class="input-sm" size="32" maxlength="255" value="<?php

echo string_attribute($t_definition['valid_regexp'])?>" />
		</td>
	</tr>
...
echo lang_get('custom_field_length_min')?>
        ...
        <td>
            <input type="text" id="custom-field-length-min" name="length_min" class="input-sm" size="32" maxlength="64" value="<?php
...
echo lang_get('custom_field_length_max')?>
        ...
        <td>
            <input type="text" id="custom-field-length-max" name="length_max" class="input-sm" size="32" maxlength="64" value="<?php

echo $t_definition['length_max']?>" />
        </td>
    </tr>
    <tr>
        <td class="category">
...
echo lang_get('custom_field_display_report')?>
		...
		<td>
			<label>
				<input type="checkbox" class="ace" id="custom-field-display-report" name="display_report" value="1" <?php

check_checked((bool) $t_definition['display_report'])?> />
				<span class="lbl"></span>
			</label>
		</td>
	</tr>
...
echo lang_get('custom_field_display_update')?>
		...
		<td>
			<label>
				<input type="checkbox" class="ace" id="custom-field-display-update" name="display_update" value="1" <?php

check_checked((bool) $t_definition['display_update'])?> />
				<span class="lbl"></span>
			</label>
		</td>
	</tr>
...
echo lang_get('custom_field_display_resolved')?>
		...
		<td>
			<label>
				<input type="checkbox" class="ace" id="custom-field-display-resolved" name="display_resolved" value="1" <?php

check_checked((bool) $t_definition['display_resolved'])?> />
				<span class="lbl"></span>
			</label>
		</td>
	</tr>
...
echo lang_get('custom_field_display_closed')?>
		...
		<td>
			<label>
				<input type="checkbox" class="ace" id="custom-field-display-closed" name="display_closed" value="1" <?php

check_checked((bool) $t_definition['display_closed'])?> />
				<span class="lbl"></span>
			</label>
		</td>
	</tr>
...
echo lang_get('custom_field_require_report')?>
		...
		<td>
			<label>
				<input type="checkbox" class="ace" id="custom-field-require-report" name="require_report" value="1" <?php

check_checked((bool) $t_definition['require_report'])?> />
				<span class="lbl"></span>
			</label>
		</td>
	</tr>
...
echo lang_get('custom_field_require_update')?>
		...
		<td>
			<label>
				<input type="checkbox" class="ace" id="custom-field-require-update" name="require_update" value="1" <?php

check_checked((bool) $t_definition['require_update'])?> />
				<span class="lbl"></span>
			</label>
		</td>
	</tr>
...
echo lang_get('custom_field_require_resolved')?>
		...
		<td>
			<label>
				<input type="checkbox" class="ace" id="custom-field-require-resolved" name="require_resolved" value="1" <?php
...
echo lang_get('custom_field_require_closed')?>
		...
		<td>
			<label>
				<input type="checkbox" class="ace" id="custom-field-require-closed" name="require_closed" value="1" <?php
