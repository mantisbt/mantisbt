...
$t_bugnote_id = null;
if( $t_bug_note->note || helper_duration_to_minutes( $t_bug_note->time_tracking ) > 0 || !empty( $f_files ) ) {
	...
	# Even if no note was entered, attachments needs to be linked to an empty note
	if( !empty( $f_files ) ) {
