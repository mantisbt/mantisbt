...
<?
	...
	else if ( strlen($g_view_reported_cookie_val)>6 ) {
		### Load preferences
		$t_setting_arr = explode( "#", $g_view_reported_cookie_val );
		$f_user_id = $t_setting_arr[0];
...
<div align=center>
	...
	[ <? echo $s_reported_bugs_link ?> ]
	[ <a href="<? echo $g_view_all_assigned_bug_page ?>"><? echo $s_assigned_bugs_link ?></a> ]
</div>
...
<tr>
	...
	<tr bgcolor=<? echo $g_category_title_color2 ?> align=center>
		<td width=8%>
			<b>
				<a href="<? echo $g_view_all_reported_bug_page ?>?f_sort=id&f_dir=<? echo $f_dir?>&f_show_category=<? echo $f_show_category ?>&f_show_severity=<? echo $f_show_severity ?>&f_show_status=<? echo $f_show_status ?>&f_limit_view=<? echo $f_limit_view ?>&f_show_changed=<? echo $f_show_changed ?>"><? echo $s_id ?></a>
			</b>
		</td>
		<td width=3%>
			<b>
		...
		<td width=12%>
			<b>
				<a href="<? echo $g_view_all_reported_bug_page ?>?f_sort=category&f_dir=<? echo $f_dir?>&f_show_category=<? echo $f_show_category ?>&f_show_severity=<? echo $f_show_severity ?>&f_show_status=<? echo $f_show_status ?>&f_limit_view=<? echo $f_limit_view ?>&f_show_changed=<? echo $f_show_changed ?>"><? echo $s_category ?></a>
			</b>
		</td>
		<td width=10%>
			<b>
				<a href="<? echo $g_view_all_reported_bug_page ?>?f_sort=severity&f_dir=<? echo $f_dir?>&f_show_category=<? echo $f_show_category ?>&f_show_severity=<? echo $f_show_severity ?>&f_show_status=<? echo $f_show_status ?>&f_limit_view=<? echo $f_limit_view ?>&f_show_changed=<? echo $f_show_changed ?>"><? echo $s_severity ?></a>
			</b>
		</td>
		<td width=10%>
			<b>
				<a href="<? echo $g_view_all_reported_bug_page ?>?f_sort=status&f_dir=<? echo $f_dir?>&f_show_category=<? echo $f_show_category ?>&f_show_severity=<? echo $f_show_severity ?>&f_show_status=<? echo $f_show_status ?>&f_limit_view=<? echo $f_limit_view ?>&f_show_changed=<? echo $f_show_changed ?>"><? echo $s_status ?></a>
			</b>
		</td>
		<td width=12%>
			<b>
				<a href="<? echo $g_view_all_reported_bug_page ?>?f_sort=last_updated&f_dir=<? echo $f_dir?>&f_show_category=<? echo $f_show_category ?>&f_show_severity=<? echo $f_show_severity ?>&f_show_status=<? echo $f_show_status ?>&f_limit_view=<? echo $f_limit_view ?>&f_show_changed=<? echo $f_show_changed ?>"><? echo $s_updated ?></a>
			</b>
		</td>
		<td width=45%>
			<b>
				<a href="<? echo $g_view_all_reported_bug_page ?>?f_sort=summary&f_dir=<? echo $f_dir?>&f_show_category=<? echo $f_show_category ?>&f_show_severity=<? echo $f_show_severity ?>&f_show_status=<? echo $f_show_status ?>&f_limit_view=<? echo $f_limit_view ?>&f_show_changed=<? echo $f_show_changed ?>"><? echo $s_summary ?></a>
			</b>
		</td>
	</tr>
	<tr height=5>
...
<?
	...
	if ( $f_offset_prev >= 0 ) {
 		PRINT "[ <a href=\"$g_view_all_reported_bug_page?f_offset=$f_offset_prev&f_show_category=$f_show_category&f_show_severity=$f_show_severity&f_show_status=$f_show_status&f_limit_view=$f_limit_view&f_show_changed=$f_show_changed&f_hide_resolved=$f_hide_resolved&f_user_id=$f_user_id\">View Prev $f_limit_view</a> ] ";
	}
	if ( $row_count == $f_limit_view ) {
 		PRINT "[ <a href=\"$g_view_all_reported_bug_page?f_offset=$f_offset_next&f_show_category=$f_show_category&f_show_severity=$f_show_severity&f_show_status=$f_show_status&f_limit_view=$f_limit_view&f_show_changed=$f_show_changed&f_hide_resolved=$f_hide_resolved&f_user_id=$f_user_id\">View Next $f_limit_view</a> ]";
	}
?>
</div>
