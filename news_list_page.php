...
<?php
	...
	for ( $i=0 ; $i < sizeof( $rows ) ; $i++ ) {
		...
		PRINT "<li><span class=\"italic-small\">$v_date_posted</span> - <span class=\"bold\"><a href=\"news_view_page.php?f_news_id=$v_id\">$v_headline</a></span> <span class=\"small\">$t_note_string</span> <a class=\"small\" href=\"mailto:$t_poster_email\">$t_poster_name</a></li>";
	}  # end for loop
?>
</ul>
