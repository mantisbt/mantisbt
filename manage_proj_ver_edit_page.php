	...
	<form id="manage-proj-version-update-form" method="post" action="manage_proj_ver_update.php">
		...
		<fieldset>
			...
			<tr>
				...
				<td>
					<input type="text" id="proj-version-date-order" name="date_order" class="datetimepicker input-sm" size="16"
						...
						data-picker-format="<?php echo config_get( 'datetime_picker_format' ) ?>"
					   	size="32" value="<?php echo (date_is_null( $t_version->date_order ) ? '' : string_attribute( date( config_get( 'normal_date_format' ), $t_version->date_order ) ) ) ?>" />
