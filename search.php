...
# Filtering by Date
$t_my_filter[FILTER_PROPERTY_FILTER_BY_CREATION_DATE] = gpc_get_bool( FILTER_PROPERTY_FILTER_BY_CREATION_DATE );
$t_my_filter[FILTER_PROPERTY_START_CREATION_MONTH] = gpc_get_int( FILTER_PROPERTY_START_CREATION_MONTH, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_START_CREATION_DAY] = gpc_get_int( FILTER_PROPERTY_START_CREATION_DAY, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_START_CREATION_YEAR] = gpc_get_int( FILTER_PROPERTY_START_CREATION_YEAR, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_END_CREATION_MONTH] = gpc_get_int( FILTER_PROPERTY_END_CREATION_MONTH, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_END_CREATION_DAY] = gpc_get_int( FILTER_PROPERTY_END_CREATION_DAY, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_END_CREATION_YEAR] = gpc_get_int( FILTER_PROPERTY_END_CREATION_YEAR, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_FILTER_BY_LAST_UPDATED_DATE] = gpc_get_bool( FILTER_PROPERTY_FILTER_BY_LAST_UPDATED_DATE );
$t_my_filter[FILTER_PROPERTY_START_LAST_UPDATED_MONTH] = gpc_get_int( FILTER_PROPERTY_START_LAST_UPDATED_MONTH, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_START_LAST_UPDATED_DAY] = gpc_get_int( FILTER_PROPERTY_START_LAST_UPDATED_DAY, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_START_LAST_UPDATED_YEAR] = gpc_get_int( FILTER_PROPERTY_START_LAST_UPDATED_YEAR, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_END_LAST_UPDATED_MONTH] = gpc_get_int( FILTER_PROPERTY_END_LAST_UPDATED_MONTH, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_END_LAST_UPDATED_DAY] = gpc_get_int( FILTER_PROPERTY_END_LAST_UPDATED_DAY, META_FILTER_ANY );
$t_my_filter[FILTER_PROPERTY_END_LAST_UPDATED_YEAR] = gpc_get_int( FILTER_PROPERTY_END_LAST_UPDATED_YEAR, META_FILTER_ANY );
